 ...
 */
goog.provide('opeth.data.model.Band');
...
*/
opeth.data.model.Band = function(opt_json, opt_minified) {
    ...
    if(goog.isDef(opt_minified) && goog.isBoolean(opt_minified) && opt_minified && goog.isDefAndNotNull(opt_json)) {
        this.id_ = new prestans.types.String({value: opt_json[opeth.data.model.Band.REWRITE_MAP["id"]], required: false, defaultValue: null, opt_maxLength: null, opt_minLength: null, format: null, choices: null});
        this.name_ = new prestans.types.String({value: opt_json[opeth.data.model.Band.REWRITE_MAP["name"]], required: true, defaultValue: null, opt_maxLength: null, opt_minLength: null, format: null, choices: null});
    }
...
goog.inherits(opeth.data.model.Band, prestans.types.Model);

opeth.data.model.Band.Meta = {
    Id: {
        REQUIRED: false,
        DEFAULT: null,
        MAX_LENGTH: null,
...
//Rewrite map
opeth.data.model.Band.REWRITE_MAP = {
    "id": "a",
    "name": "b"
};

//Reverse rewrite map
opeth.data.model.Band.REVERSE_REWRITE_MAP = {
    "a": "id",
    "b": "name"
};

opeth.data.model.Band.prototype.getId = function() {
    return this.id_.getValue();
};

opeth.data.model.Band.prototype.setId = function(value) {
...
opeth.data.model.Band.prototype.getName = function() {
    return this.name_.getValue();
};

opeth.data.model.Band.prototype.setName = function(value) {
...
opeth.data.model.Band.prototype.setValueForKey = function(key, value) {
...
opeth.data.model.Band.prototype.getValueForKey = function(key) {
...
opeth.data.model.Band.prototype.clone = function(opt_filter) {
    var json_ = this.getJSONObject(false, opt_filter);
    return new opeth.data.model.Band(json_, false);
};
...
opeth.data.model.Band.prototype.getJSONObject = function(minified, opt_filter) {
    ...
    if(goog.isDef(minified) && goog.isBoolean(minified) && minified) {
            ...
            jsonifiedObject_[opeth.data.model.Band.REWRITE_MAP["id"]] = this.getId()
        else if(!goog.isDef(opt_filter))
            jsonifiedObject_[opeth.data.model.Band.REWRITE_MAP["id"]] = this.getId()
                    if(goog.isDef(opt_filter) && opt_filter.getName())
            jsonifiedObject_[opeth.data.model.Band.REWRITE_MAP["name"]] = this.getName()
        else if(!goog.isDef(opt_filter))
            jsonifiedObject_[opeth.data.model.Band.REWRITE_MAP["name"]] = this.getName()
            }
    else {
